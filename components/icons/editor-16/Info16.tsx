...
export interface Info16Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const Info16 = React.forwardRef<SVGSVGElement, Info16Props>(
