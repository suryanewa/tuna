...
export interface Rectangle16Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const Rectangle16 = React.forwardRef<SVGSVGElement, Rectangle16Props>(
...
Rectangle16.displayName = "Rectangle16";
