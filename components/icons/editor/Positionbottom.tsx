...
export interface PositionbottomProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const Positionbottom = React.forwardRef<SVGSVGElement, PositionbottomProps>(
