...
export interface StrokeDiamondArrowProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const StrokeDiamondArrow = React.forwardRef<SVGSVGElement, StrokeDiamondArrowProps>(
...
StrokeDiamondArrow.displayName = "StrokeDiamondArrow";
