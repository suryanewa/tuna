...
export interface VersionCurrentProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const VersionCurrent = React.forwardRef<SVGSVGElement, VersionCurrentProps>(
