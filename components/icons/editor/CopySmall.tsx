...
export interface CopySmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const CopySmall = React.forwardRef<SVGSVGElement, CopySmallProps>(
