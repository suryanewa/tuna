...
export interface AlSpacingVerticalProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const AlSpacingVertical = React.forwardRef<SVGSVGElement, AlSpacingVerticalProps>(
...
AlSpacingVertical.displayName = "AlSpacingVertical";
