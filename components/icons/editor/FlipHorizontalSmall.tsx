...
export interface FlipHorizontalSmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const FlipHorizontalSmall = React.forwardRef<SVGSVGElement, FlipHorizontalSmallProps>(
...
FlipHorizontalSmall.displayName = "FlipHorizontalSmall";
