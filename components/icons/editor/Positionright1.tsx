...
export interface Positionright1Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const Positionright1 = React.forwardRef<SVGSVGElement, Positionright1Props>(
