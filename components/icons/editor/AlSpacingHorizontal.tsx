...
export interface AlSpacingHorizontalProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const AlSpacingHorizontal = React.forwardRef<SVGSVGElement, AlSpacingHorizontalProps>(
...
AlSpacingHorizontal.displayName = "AlSpacingHorizontal";
