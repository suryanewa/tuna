...
export interface RadiusTopLeftProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const RadiusTopLeft = React.forwardRef<SVGSVGElement, RadiusTopLeftProps>(
...
RadiusTopLeft.displayName = "RadiusTopLeft";
