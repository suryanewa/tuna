...
export interface WarningSmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const WarningSmall = React.forwardRef<SVGSVGElement, WarningSmallProps>(
