...
export interface Positionleft1Props extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const Positionleft1 = React.forwardRef<SVGSVGElement, Positionleft1Props>(
