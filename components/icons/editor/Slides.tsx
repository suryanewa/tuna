...
export interface SlidesProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const Slides = React.forwardRef<SVGSVGElement, SlidesProps>(
