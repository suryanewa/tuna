...
export interface HomeSmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const HomeSmall = React.forwardRef<SVGSVGElement, HomeSmallProps>(
