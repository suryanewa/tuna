...
export interface FillSolidSmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const FillSolidSmall = React.forwardRef<SVGSVGElement, FillSolidSmallProps>(
