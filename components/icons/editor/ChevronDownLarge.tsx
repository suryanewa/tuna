...
export interface ChevronDownLargeProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const ChevronDownLarge = React.forwardRef<SVGSVGElement, ChevronDownLargeProps>(
