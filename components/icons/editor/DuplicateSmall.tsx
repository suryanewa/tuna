...
export interface DuplicateSmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const DuplicateSmall = React.forwardRef<SVGSVGElement, DuplicateSmallProps>(
