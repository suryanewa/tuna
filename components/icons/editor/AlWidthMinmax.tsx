...
export interface AlWidthMinmaxProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const AlWidthMinmax = React.forwardRef<SVGSVGElement, AlWidthMinmaxProps>(
