...
export interface TextAlignMiddleProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const TextAlignMiddle = React.forwardRef<SVGSVGElement, TextAlignMiddleProps>(
