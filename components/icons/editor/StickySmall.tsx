...
export interface StickySmallProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const StickySmall = React.forwardRef<SVGSVGElement, StickySmallProps>(
